...
namespace DiziYorumProje.AdminSayfalar
{
    public partial class YorumGuncelle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                var valuesBlog = (from x in db.TBLBLOG
                                  select new
                                  {
                                      x.BLOGBASLIK,
                                      x.BLOGID
                                  }).ToList();
                DropDownList1.DataSource = valuesBlog;
                DropDownList1.DataBind();


                var deger = db.TBLYORUM.Find(y);
                TextBox1.Text = deger.KULLANICIAD;
                TextBox2.Text = deger.YORUMICERIK;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            yorum.YORUMICERIK = TextBox2.Text;
            yorum.YORUMBLOG = int.Parse(DropDownList1.SelectedValue);
            db.SaveChanges();
